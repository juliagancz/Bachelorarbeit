...
for i = 1:18
    ...
    SNR_ju(:,10) = []; %für kanal 9
    SNR_ju(:,1) = []; %für kanal 18
    std_noise(:,10) = [];
    std_noise(:,1) = [];
    ...
    spikes_gold = mean(cell2mat(number_spikes(1,2:9)));
    amplitude_pedot = mean(cell2mat(amplitudespike(1,11:18)));
    amplitude_gold = mean(cell2mat(amplitudespike(1,2:9)));
    amplitude_pedot_std = std(cell2mat(amplitudespike(1,11:18)));
    amplitude_gold_std = std(cell2mat(amplitudespike(1,2:9)));
